...
**Software Engineer @ Bank of America** | Ex-Amazon SDE Intern | AI/ML Enthusiast

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=flat&logo=linkedin)](https://www.linkedin.com/in/harinee-j-298529234/)
[![Email](https://img.shields.io/badge/Email-Contact-D14836?style=flat&logo=gmail)](mailto:harineejaykumar07@gmail.com)
[![LeetCode](https://img.shields.io/badge/LeetCode-300%2B%20Problems-FFA116?style=flat&logo=leetcode)](https://leetcode.com/Harxnee)
![Profile Views](https://komarev.com/ghpvc/?username=Harxnee&color=blueviolet)

---

## 👨‍💻 About Me

I'm a Software Engineer at **Bank of America** with prior experience as an SDE Intern at **Amazon**, where I built low-latency data security solutions and migrated legacy systems to microservices. I specialize in backend engineering, distributed systems, and data pipelines.

- 🏢 Currently working on **production-grade ETL pipelines** and **batch processing workflows** at Bank of America
- 🚀 Previously built a **2ms latency data security package** at Amazon, deployed across 7+ production services
- 🏆 Winner of **JP Morgan Chase Code for Good Hackathon (2024)** and **Haxios Hackathon (2023)**
- 🎓 B.Tech in CSE (AI/ML) from **VIT** with **8.91 CGPA**
- 💡 Passionate about **system design**, **scalable architectures**, and solving **complex algorithmic problems**
- 📊 Solved **300+ DSA problems** on LeetCode, GeeksforGeeks, and HackerRank
...
- Automated Python & SQL preprocessing workflows, reducing manual effort by **30%**
- Monitored 10+ production Autosys jobs and Spark batch workflows, reducing recurring failures
- Performed data analysis on large datasets to improve data quality and pipeline stability

### Amazon — Software Development Engineer Intern
*Jan 2025 – Jun 2025*

- Designed a **2ms latency data security package** adopted across **7+ production services**, reducing risk by **35%**
- Led backend migration to microservices, improving performance by **40%**
- Resolved serverless failures, eliminating **25 Sev2 incidents/month** and saving **20+ engineering hours**
- Built internal encryption/decryption utility, reducing debugging time by **30%**

---

## 🚀 Featured Projects

### 🗺️ Routecraft — Garbage Route Optimization System
*Python • Geospatial Analysis • A* Algorithm • REST APIs*

Route optimization solution reducing municipal fuel consumption by **25%** and travel time by **30%**

### 💪 FitBeat — Gamified Fitness Platform
*React.js • TensorFlow • OpenCV • Node.js*

Microservices-based fitness platform with **70%** increased engagement and **92%** activity recognition accuracy

---

## 🏆 Achievements & Recognition

- 🥇 **Winner** — JP Morgan Chase Code for Good Hackathon (2024)
- 🥇 **Winner** — Haxios Hackathon (2023)
- 📜 **Design Patent Granted** (2024) — Waste Water Reuse Indicator
- 👩‍💻 **Student Fellow** — Google-supported Women Engineers' Program (Top 1% of 25,000+ applicants)
- 🎓 **Udacity Nanodegree** — AI Programming with Python (AWS-sponsored)
- 🌍 **Global Top 100 Fellow** — Aptos Fellowship Program
- 💰 **Scholarship Recipient** — InfoCepts Innovate for Impact & AnitaB.org Advancing Inclusion
...
![Harinee's GitHub stats](https://github-readme-stats.vercel.app/api?username=Harxnee&show_icons=true&theme=dark&hide_border=true&count_private=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Harxnee&layout=compact&theme=dark&hide_border=true)

![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=Harxnee&theme=dark&hide_border=true)

---

## 📫 Let's Connect!

I'm always open to discussing software engineering, system design, or collaboration opportunities. Feel free to reach out!
...
⭐️ From [Harxnee](https://github.com/Harxnee)
